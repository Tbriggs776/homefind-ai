...
export default function NearbyBanner({ locationStatus, onRequestLocation, onDismiss }) {
  ...
  return (
    <div className="bg-primary/10 border border-primary/30 rounded-lg p-4 mb-6 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        {locationStatus === 'loading' ? (
          ...
          <>
            <Button size="sm" onClick={onRequestLocation} className="bg-primary hover:bg-[var(--crandell-primary-hover)] text-primary-foreground select-none">
              Enable
            </Button>
