...
Deno.serve(async (req) => {
    try {
        ...
        // Test 1: Replication API with filter
        ...
        // Test 2: Standard API endpoint with OAuth token
        ...
        // Test 3: Try different field name - ListAgentId instead of ListAgentMlsId
        ...
        // Test 4: Search for Paul Crandell by name
        ...
        results.by_agent_name = {
            ...
            listings: (data4.D?.Results || []).map(l => ({
